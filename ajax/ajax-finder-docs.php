...
if($num>0){
  for($i=0;$i<$num;$i++){
    ...
    $nomb= $fila_nombre." (".$fila_tipo.")";
    echo "<li class='finder-item item-doc' seleccionado='off' title='".$nomb."' nombre='".$nomx."' item='".$fila_id."' tipo_item='$icon' id='item-d-$i' url='".$fila_url."'  url_mini='".$url."' style='' ><i class='icn icn-$icon'></i><span class='nombre' title='$fila_nombre'>".$nom."</span><div class='etiquetas'>".$etiquetas."</div></li>";
  }
}
?>
