...
class EMPRESAS{
    ...
    <div class="body-modulo container-fluid">
        ...
        $consulta = "SELECT emp_id, emp_nombre, emp_logo, emp_telefono, emp_email, emp_tip_tip_id, emp_activar FROM empresa,empresa_tipos WHERE emp_activar=1 and emp_id=emp_tip_emp_id ORDER BY emp_tip_orden  desc";
